                            ...
                            @endif
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <select required id="inputState" class="default-select form-control wide" id="group" name="group_id">
                                  ...
                                  <div class="mb-3 col-md-6">
                                    <input required type="hidden" value="0" class="form-control" placeholder=""  name="roll_id"/>

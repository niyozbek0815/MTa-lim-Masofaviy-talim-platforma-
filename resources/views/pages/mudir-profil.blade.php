        ...
        <div class="profil-area">
            ...
            <div class="profil-text">
                ...
                <div class="profil-date">
                    <div class="uroven">Professor Datsent</div>
                </div>
            </div>
        </div>
...
<div class="profil-menu-area ">
    ...
    <div class="site-container">
        ...
        <a href="{{url("/mudir/cource-response")  }}" class="profil-settings-box settings-color-2">
            <div class="settings-left"><i class="far fa-plus settings-text-2"></i></div>
            <p>Add New Cource</p>
        </a>
